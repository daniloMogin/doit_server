...
class Functions {
    ...
    public validateRegister = (user, res: Response): any => {
        ...
        const month_validate = this.validateDayMonth(separatedDoB.month, 'Month', 1, 12);
        ...
        const gender_validate = this.validateStringEmptyMinMaxLenRegexpInput(
            user.gender,
            'Gender',
            1,
            10
    ...
    private validateBirthday = (
        ...
        const days_in_month: number = this.daysInMonth(
            monthTemp,
            yearTemp
        );
